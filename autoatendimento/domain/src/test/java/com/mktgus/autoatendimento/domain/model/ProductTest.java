...
class ProductTest {
    ...
    void shouldCreateProductWithValidData() {
        Product product = new Product("7891234567890", "Café Solúvel", null, 15.90, false, null);
    ...
    void shouldRejectBlankEan() {
        assertThrows(IllegalArgumentException.class, () -> new Product("", "Nome", null, 10.0, false, null));
    }

    @Test
    void shouldRejectNullEan() {
        assertThrows(IllegalArgumentException.class, () -> new Product(null, "Nome", null, 10.0, false, null));
    }

    @Test
    void shouldRejectBlankName() {
        assertThrows(IllegalArgumentException.class, () -> new Product("123", " ", null, 10.0, false, null));
    }

    @Test
    void shouldRejectNegativePrice() {
        assertThrows(IllegalArgumentException.class, () -> new Product("123", "Nome", null, -1.0, false, null));
    }

    @Test
    void requiresAgeVerificationShouldReflectAdultOnlyFlag() {
        Product adult = new Product("123", "Cerveja", null, 8.0, true, null);
        Product regular = new Product("456", "Suco", null, 5.0, false, null);
    ...
    void hasPriceDivergenceShouldDetectDifferencesAboveThreshold() {
        Product product = new Product("123", "Pão", null, 10.0, false, null);
