...
public class ConfirmPaymentUseCase {
    ...
    public ConfirmPaymentUseCase(PaymentGateway paymentGateway, PaymentTransactionGateway paymentTransactionGateway) {
    ...
    public PaymentStatusOutput execute(Long transactionId) {
        ...
        var providerResult = paymentGateway.confirm(transaction);
